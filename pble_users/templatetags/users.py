...
def get_user(user, anonymous=False):
    ...
    return mark_safe('<a href="' + reverse('pble_users:detail', args=(user.pk,)) + '" class="pble-user-link">'
                     + name + '</a>')
...
def userprofile_get_user(userprofile):
    ...
    return mark_safe('<a href="' + reverse('pble_users:detail', args=(userprofile.user.pk,)) + '" class="pble-user-link">'
                     + full_name + '</a>')
